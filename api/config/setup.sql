...
(15, 'Sports Science GCSE', 'What is the name of the muscle found at the back of the upper arm?', 'Triceps', 'Biceps', 'Quadriceps', 'Hamstrings'),
(15, 'Sports Science GCSE', 'What is the maximum number of players allowed on a basketball court at the same time?', '5', '6', '7', '8'),
(15, 'Sports Science GCSE', 'What is the name of the process by which glucose is converted to energy in the body?', 'Glycolysis', 'Krebs Cycle', 'Electron Transport Chain', 'Fermentation'),
(15, 'Sports Science GCSE', 'What is the name of the condition that occurs when the body''s core temperature rises above normal levels?', 'Hyperthermia', 'Hypothermia', 'Dehydration', 'Heat Exhaustion'),
(15, 'Sports Science GCSE', 'What is the name of the gland in the brain that produces hormones such as growth hormone and prolactin?', 'Pituitary gland', 'Thyroid gland', 'Adrenal gland', 'Pancreas'),
(15, 'Sports Science GCSE', 'What is the name of the scoring move in wrestling that involves pinning an opponent to the mat?', 'Fall', 'Escape', 'Takedown', 'Reversal'),
(15, 'Sports Science GCSE', 'What is the name of the muscle found at the front of the upper leg?', 'Quadriceps', 'Hamstrings', 'Gluteus maximus', 'Gastrocnemius'),
(15, 'Sports Science GCSE', 'What is the name of the hormone that is produced by the adrenal gland and helps the body to respond to stress?', 'Cortisol', 'Insulin', 'Testosterone', 'Estrogen'),
(15, 'Sports Science GCSE', 'What is the name of the small bone located in the wrist between the radius and the ulna?', 'Scaphoid', 'Talus', 'Femur', 'Patella'),
(15, 'Sports Science GCSE', 'What is the name of the condition in which a muscle becomes inflamed due to overuse?', 'Tendinitis', 'Arthritis', 'Bursitis', 'Osteoporosis'),
(15, 'Sports Science GCSE', 'What is the name of the process by which oxygen is transported from the lungs to the body tissues?', 'Respiration', 'Circulation', 'Digestion', 'Excretion'),
(15, 'Sports Science GCSE', 'What is the name of the measurement used to assess body fat based on height and weight?', 'Body mass index (BMI)', 'Body composition', 'Body density', 'Waist-to-hip ratio'),
(15, 'Sports Science GCSE', 'What is the name of the joint that connects the thigh bone to the pelvis?', 'Hip joint', 'Knee joint', 'Ankle joint', 'Shoulder joint'),
(15, 'Sports Science GCSE', 'What is the name of the hormone that regulates blood sugar levels in the body?', 'Insulin', 'Glucagon', 'Epinephrine', 'Norepinephrine'),
(15, 'Sports Science GCSE', 'What is the name of the protein that makes up muscle fibers?', 'Myosin', 'Actin', 'Collagen', 'Elastin'),
(15, 'Sports Science GCSE', 'What is the name of the energy system that provides short bursts of energy for high-intensity exercise?', 'ATP-PC system', 'Glycolytic system', 'Aerobic system', 'Anaerobic system'),
(15, 'Sports Science GCSE', 'What is the name of the bone located at the base of the skull?', 'Occipital bone', 'Temporal bone', 'Parietal bone', 'Frontal bone'),
(15, 'Sports Science GCSE', 'What is the name of the process by which food is broken down in the body to release energy?', 'Metabolism', 'Digestion', 'Absorption', 'Excretion'),
(15, 'Sports Science GCSE', 'What is the name of the muscle that separates the chest cavity from the abdominal cavity?', 'Diaphragm', 'Intercostal muscles', 'Pectoralis major', 'Latissimus dorsi'),
(15, 'Sports Science GCSE', 'What is the name of the joint that connects the upper arm bone to the shoulder blade?', 'Glenohumeral joint', 'Elbow joint', 'Wrist joint', 'Hip joint'),
(16, 'Sports Science A-Level', 'What is the name of the hormone that stimulates milk production in lactating women?', 'Prolactin', 'Oxytocin', 'Estrogen', 'Progesterone'),
(16, 'Sports Science A-Level', 'What is the name of the condition in which the heart is unable to pump enough blood to meet the body''s needs?', 'Heart failure', 'Heart attack', 'Arrhythmia', 'Cardiomyopathy'),
(16, 'Sports Science A-Level', 'What is the name of the system in the body that regulates the balance of fluids and electrolytes?', 'Renin-angiotensin-aldosterone system', 'Lymphatic system', 'Endocrine system', 'Immune system'),
(16, 'Sports Science A-Level', 'What is the name of the muscle that allows you to lift your foot upwards?', 'Tibialis anterior', 'Gastrocnemius', 'Soleus', 'Peroneus longus'),
(16, 'Sports Science A-Level', 'What is the name of the hormone that stimulates the production of red blood cells in the bone marrow?', 'Erythropoietin', 'Testosterone', 'Growth hormone', 'Thyroid hormone'),
(16, 'Sports Science A-Level', 'What is the name of the type of muscle fiber that is used for endurance activities?', 'Slow-twitch (Type I) fibers', 'Fast-twitch (Type IIa) fibers', 'Fast-twitch (Type IIb) fibers', 'Intermediate fibers'),
(16, 'Sports Science A-Level', 'What is the name of the layer of connective tissue that surrounds individual muscle fibers?', 'Endomysium', 'Perimysium', 'Epimysium', 'Fascia'),
(16, 'Sports Science A-Level', 'What is the name of the process by which the body breaks down fats to use as an energy source?', 'Beta-oxidation', 'Gluconeogenesis', 'Glycogenolysis', 'Ketogenesis'),
(16, 'Sports Science A-Level', 'What is the name of the joint that connects the two pubic bones at the front of the pelvis?', 'Pubic symphysis', 'Sacrococcygeal joint', 'Sacroiliac joint', 'Coccyx joint'),
(16, 'Sports Science A-Level', 'What is the name of the condition that occurs when the blood supply to a bone is disrupted, leading to bone cell death?', 'Avascular necrosis', 'Osteoporosis', 'Rickets', 'Osteomalacia'),
(17, 'Religious Education GCSE', 'What is the name of the first book of the Torah in Judaism?', 'Genesis', 'Exodus', 'Leviticus', 'Numbers'),
(17, 'Religious Education GCSE', 'What is the name of the Muslim pilgrimage to Mecca?', 'Hajj', 'Umrah', 'Ramadan', 'Eid al-Fitr'),
(17, 'Religious Education GCSE', 'What is the name of the holy book of Sikhism?', 'Guru Granth Sahib', 'Vedas', 'Bhagavad Gita', 'Quran'),
(17, 'Religious Education GCSE', 'What is the name of the Hindu festival of lights?', 'Diwali', 'Holi', 'Navratri', 'Raksha Bandhan'),
(17, 'Religious Education GCSE', 'What is the name of the Jewish day of atonement?', 'Yom Kippur', 'Rosh Hashanah', 'Passover', 'Hanukkah'),
(17, 'Religious Education GCSE', 'What is the name of the Christian sacrament in which bread and wine are consumed?', 'Eucharist', 'Baptism', 'Confirmation', 'Holy Orders'),
(17, 'Religious Education GCSE', 'What is the name of the Buddhist concept of non-attachment?', 'Anatta', 'Anicca', 'Dukkha', 'Nirvana'),
(17, 'Religious Education GCSE', 'What is the name of the Islamic declaration of faith?', 'Shahada', 'Salat', 'Zakat', 'Hajj'),
(17, 'Religious Education GCSE', 'What is the name of the Jewish festival of lights?', 'Hanukkah', 'Passover', 'Rosh Hashanah', 'Yom Kippur'),
(17, 'Religious Education GCSE', 'What is the name of the Sikh festival celebrating the birth of Guru Nanak?', 'Guru Nanak Gurpurab', 'Diwali', 'Vaisakhi', 'Lohri'),
(17, 'Religious Education GCSE', 'What is the name of the Taoist concept of balance and harmony?', 'Yin and Yang', 'Wu Wei', 'Tao Te Ching', 'Qi'),
(17, 'Religious Education GCSE', 'What is the name of the Christian holiday celebrating the birth of Jesus Christ?', 'Christmas', 'Easter', 'Good Friday', 'Pentecost'),
(17, 'Religious Education GCSE', 'What is the name of the Islamic month of fasting?', 'Ramadan', 'Shawwal', 'Muharram', 'Dhu al-Hijjah'),
(17, 'Religious Education GCSE', 'What is the name of the Hindu god of destruction?', 'Shiva', 'Vishnu', 'Brahma', 'Ganesha'),
(17, 'Religious Education GCSE', 'What is the name of the Jewish festival celebrating the liberation of the Israelites from slavery in Egypt?', 'Passover', 'Hanukkah', 'Yom Kippur', 'Rosh Hashanah'),
(17, 'Religious Education GCSE', 'What is the name of the Buddhist concept of the end of suffering?', 'Nirvana', 'Samsara', 'Bodhisattva', 'Meditation'),
(17, 'Religious Education GCSE', 'What is the name of the Christian prayer that begins with "Our Father"?', 'The Lord''s Prayer', 'Hail Mary', 'Nicene Creed', 'Apostles'' Creed'),
(17, 'Religious Education GCSE', 'What is the name of the Islamic holy city?', 'Mecca', 'Medina', 'Jerusalem', 'Karbala'),
(17, 'Religious Education GCSE', 'What is the name of the Jewish day of rest?', 'Shabbat', 'Yom Kippur', 'Rosh Hashanah', 'Passover'),
(17, 'Religious Education GCSE', 'What is the name of the Sikh holy book?', 'Guru Granth Sahib', 'Dasam Granth', 'Anand Sahib', 'Japji Sahib'),
(18, 'Religious Education A-Level', 'What is the name of the Buddhist scripture that contains the teachings of the Buddha?', 'Tripitaka', 'Mahabharata', 'Ramayana', 'Bhagavad Gita'),
(18, 'Religious Education A-Level', 'What is the name of the Christian religious rite in which a person is immersed in water?', 'Baptism', 'Communion', 'Confirmation', 'Eucharist'),
(18, 'Religious Education A-Level', 'What is the name of the Hindu scripture that contains the teachings of Lord Krishna?', 'Bhagavad Gita', 'Upanishads', 'Vedas', 'Puranas'),
(18, 'Religious Education A-Level', 'What is the name of the Jewish day of atonement?', 'Yom Kippur', 'Rosh Hashanah', 'Passover', 'Hanukkah'),
(18, 'Religious Education A-Level', 'What is the name of the Islamic holy book?', 'Quran', 'Hadith', 'Sunnah', 'Shariah'),
(18, 'Religious Education A-Level', 'What is the name of the Sikh martial art that combines physical and spiritual training?', 'Gatka', 'Kalaripayattu', 'Wushu', 'Muay Thai'),
(18, 'Religious Education A-Level', 'What is the name of the Taoist text that contains the teachings of Lao Tzu?', 'Tao Te Ching', 'I Ching', 'Zhuangzi', 'Liezi'),
(18, 'Religious Education A-Level', 'What is the name of the Christian doctrine that teaches the three persons of the Trinity are equal in substance?', 'Nicene Creed', 'Apostles'' Creed', 'Athanasian Creed', 'Chalcedonian Creed'),
...
('Geography', 'What is the longest river in Africa?', 'Nile'),
('Geography', 'What is the smallest country in the world?', 'Vatican City'),
('Geography', 'What is the capital of Italy?', 'Rome'),
('Geography', 'What is the largest desert in the world?', 'Sahara Desert'),
('Geography', 'What is the capital of Egypt?', 'Cairo'),
('Geography', 'What is the largest island in the world?', 'Greenland'),
('Geography', 'What is the highest mountain in the world?', 'Mount Everest'),
('Geography', 'What is the capital of Australia?', 'Canberra'),
('Geography', 'What is the largest ocean in the world?', 'Pacific Ocean'),
('Geography', 'What is the smallest continent?', 'Australia'),
('Geography', 'What is the capital of Russia?', 'Moscow'),
('Geography', 'What is the largest lake in Africa?', 'Lake Victoria'),
('Geography', 'What is the highest peak in North America?', 'Denali/Mount McKinley'),
('Geography', 'What is the longest river in Europe?', 'Volga River'),
('Geography', 'What is the capital of Canada?', 'Ottawa'),
('Geography', 'What is the largest country in the world?', 'Russia'),
('History', 'Who was the first female Prime Minister of the UK?', 'Margaret Thatcher'),
('History', 'Who was the monarch during the Elizabethan era?', 'Queen Elizabeth I'),
('History', 'Which British monarch was known as the ''Virgin Queen''?', 'Queen Elizabeth I'),
('History', 'Who was the leader of the Labour Party during WWII?', 'Clement Attlee'),
('History', 'What event in 1066 is known as the last successful invasion of England?', 'The Norman Conquest'),
('History', 'What was the name of the ship that transported the Pilgrims to the New World in 1620?', 'Mayflower'),
('History', 'Which king was beheaded during the English Civil War?', 'King Charles I'),
('History', 'What was the name of the first successful steam locomotive, invented by George Stephenson?', 'The Rocket'),
('History', 'What was the name of the first British female physician, who practiced medicine in the 19th century?', 'Elizabeth Garrett Anderson'),
('History', 'What was the name of the first woman to be elected to the UK Parliament?', 'Constance Markievicz'),
('History', 'What was the name of the war fought between England and France from 1337 to 1453?', 'The Hundred Years'' War'),
('History', 'Who was the king of England during the Battle of Hastings?', 'Harold II'),
('History', 'What was the name of the infamous prison in London that was in use from the 12th century until 1952?', 'The Tower of London'),
('History', 'Who was the leader of the suffragette movement in the early 20th century?', 'Emmeline Pankhurst'),
('History', 'What was the name of the British passenger liner that sank in the North Atlantic Ocean in 1912?', 'The Titanic'),
('History', 'Which British monarch was known as the ''Merry Monarch''?', 'King Charles II'),
('History', 'Who was the leader of the UK during World War II?', 'Winston Churchill'),
('History', 'What was the name of the battle fought in 1314 where the Scots defeated the English?', 'The Battle of Bannockburn'),
('History', 'Who was the first British monarch to be publicly crowned in a Christian ceremony?', 'King Æthelstan'),
('History', 'What was the name of the military campaign during World War II where the UK and its allies invaded Nazi-occupied Europe?', 'D-Day'),
('Chemistry', 'What is the most abundant element in the Earth''s atmosphere?', 'Nitrogen'),
('Chemistry', 'What is the lightest element?', 'Hydrogen'),
('Chemistry', 'What is the densest naturally occurring element?', 'Osmium'),
('Chemistry', 'What element is the primary component of diamonds?', 'Carbon'),
('Chemistry', 'What element has the symbol Fe?', 'Iron'),
('Chemistry', 'What element is used to make light bulbs?', 'Tungsten'),
('Chemistry', 'What element has the atomic number 79?', 'Gold'),
('Chemistry', 'What element is used to make computer chips?', 'Silicon'),
('Chemistry', 'What element is commonly used as a coolant in nuclear reactors?', 'Helium'),
('Chemistry', 'What element has the atomic number 47?', 'Silver'),
('Chemistry', 'What element is used in thermometers?', 'Mercury'),
('Chemistry', 'What is the rarest naturally occurring element?', 'Astatine'),
('Chemistry', 'What element is used to create purple color in fireworks?', 'Potassium'),
('Chemistry', 'What is the only element that is a liquid at room temperature?', 'Mercury'),
('Chemistry', 'What element is used to create blue color in fireworks?', 'Copper'),
('Chemistry', 'What element is used to create red color in fireworks?', 'Strontium'),
('Chemistry', 'What element is used in batteries?', 'Lithium'),
('Chemistry', 'What is the heaviest element that occurs naturally?', 'Uranium'),
('Chemistry', 'What element is used to make fertilizer?', 'Phosphorus'),
('Chemistry', 'What is the most electronegative element?', 'Fluorine'),
('Biology', 'What is the smallest unit of life that can function independently called?', 'Cell'),
('Biology', 'What is the term for the process by which green plants and some other organisms use sunlight to synthesize foods with the help of chlorophyll?', 'Photosynthesis'),
('Biology', 'What is the term for the basic unit of heredity that contains the instructions for making a particular protein?', 'Gene'),
('Biology', 'What is the term for the process by which the body produces new blood vessels?', 'Angiogenesis'),
('Biology', 'What is the term for the process by which organisms break down complex organic compounds into simpler substances and release energy in the process?', 'Respiration'),
('Biology', 'What is the term for the process by which cells divide and reproduce?', 'Mitosis'),
('Biology', 'What is the term for the process by which organisms exchange gases with the environment?', 'Respiration'),
('Biology', 'What is the term for the process by which an organism changes its behavior, physiology, or structure in response to its environment?', 'Adaptation'),
('Biology', 'What is the term for the process by which a gene or set of genes is turned on or off, controlling the production of a particular protein?', 'Gene expression'),
('Biology', 'What is the term for the type of cell division that produces gametes, such as sperm and eggs?', 'Meiosis'),
('Biology', 'What is the term for the process by which a virus enters a host cell and takes over the host''s cellular machinery to reproduce itself?', 'Viral replication'),
('Biology', 'What is the term for the process by which an organism''s genetic makeup is altered, either intentionally or unintentionally?', 'Mutation'),
('Biology', 'What is the term for the process by which an organism''s physical characteristics are passed on from one generation to the next?', 'Heredity'),
('Biology', 'What is the term for the process by which an organism''s DNA is copied in preparation for cell division?', 'DNA replication'),
('Biology', 'What is the term for the process by which the body''s immune system fights off foreign invaders, such as bacteria and viruses?', 'Immune response'),
('Biology', 'What is the term for the process by which the body breaks down food into nutrients that can be absorbed and used by the body''s cells?', 'Digestion'),
('Biology', 'What is the term for the process by which an organism grows and develops from a fertilized egg into an adult?', 'Development'),
('Biology', 'What is the term for the process by which a plant produces offspring that are genetically identical to the parent plant?', 'Asexual reproduction'),
('Biology', 'What is the term for the process by which an organism takes in oxygen and releases carbon dioxide?', 'Respiration'),
('Biology', 'What is the term for the process by which an organism moves in response to a stimulus, such as light or temperature?', 'Taxis'),
('Physics', 'What is the force that opposes motion between two surfaces in contact?', 'Friction'),
('Physics', 'What is the formula for calculating work?', 'Work = Force x Distance'),
('Physics', 'What is the force that causes an object to fall to the ground?', 'Gravity'),
('Physics', 'What is the unit of measurement for frequency?', 'Hertz'),
('Physics', 'What is the law that states that every action has an equal and opposite reaction?', 'Newton''s Third Law of Motion'),
('Physics', 'What is the formula for calculating force?', 'Force = Mass x Acceleration'),
('Physics', 'What is the unit of measurement for power?', 'Watt'),
('Physics', 'What is the force that holds atoms together in a molecule?', 'Chemical Bonding'),
('Physics', 'What is the law that states that the total energy in a system remains constant?', 'Law of Conservation of Energy'),
('Physics', 'What is the unit of measurement for electric current?', 'Ampere'),
('Physics', 'What is the phenomenon where a wave changes direction as it passes through a medium?', 'Refraction'),
('Physics', 'What is the unit of measurement for electric potential difference?', 'Volt'),
('Physics', 'What is the phenomenon where light waves change direction as they pass through an opening?', 'Diffraction'),
('Physics', 'What is the unit of measurement for resistance?', 'Ohm'),
('Physics', 'What is the force that causes a moving object to curve?', 'Centripetal Force'),
('Physics', 'What is the unit of measurement for capacitance?', 'Farad'),
('Physics', 'What is the phenomenon where waves overlap and combine?', 'Interference'),
('Physics', 'What is the unit of measurement for magnetic field strength?', 'Tesla'),
('Physics', 'What is the unit of measurement for frequency?', 'Hertz'),
('Physics', 'What is the formula for calculating the speed of an object?', 'Speed = Distance / Time'),
('Maths', 'What is the branch of mathematics that deals with the study of shapes, sizes, and positions of objects?', 'Geometry'),
('Maths', 'What is the term for a mathematical statement that is accepted as true without proof?', 'Axiom'),
('Maths', 'What is the branch of mathematics that deals with the study of quantities, their relationships, and properties?', 'Algebra'),
('Maths', 'What is the term for a number that cannot be expressed as a fraction, such as pi or the square root of 2?', 'Irrational number'),
('Maths', 'What is the term for the number that is the result of multiplying a number by itself?', 'Square'),
('Maths', 'What is the term for the process of finding the derivative of a function?', 'Differentiation'),
('Maths', 'What is the term for the process of finding the indefinite integral of a function?', 'Integration'),
('Maths', 'What is the term for the study of the properties and relationships of points, lines, angles, and figures in space?', 'Euclidean geometry'),
('Maths', 'What is the term for the set of all points in a plane that are equidistant from a fixed point called the center?', 'Circle'),
('Maths', 'What is the term for the measure of the amount of space occupied by a three-dimensional object, measured in cubic units?', 'Volume'),
('Maths', 'What is the term for a mathematical function that is defined by a polynomial, or a sum of terms, each consisting of a constant multiplied by a power of a variable?', 'Polynomial function'),
('Maths', 'What is the term for a mathematical function that describes a smooth, continuous curve?', 'Analytic function'),
('Maths', 'What is the term for the study of the properties and relationships of numbers, including integers, rational numbers, and real numbers?', 'Number theory'),
('Maths', 'What is the term for the branch of mathematics that deals with the study of probability and random events?', 'Probability theory'),
('Maths', 'What is the term for a mathematical equation that relates two or more variables?', 'Equation'),
('Maths', 'What is the term for a measure of the amount of matter in an object?', 'Mass'),
('Maths', 'What is the term for a mathematical operation that combines two numbers, called addends, into a single number, called the sum?', 'Addition'),
('Maths', 'What is the term for a mathematical operation that finds the difference between two numbers, called minuends and subtrahends?', 'Subtraction'),
('Maths', 'What is the term for a mathematical operation that finds the product of two numbers, called factors?', 'Multiplication'),
('Maths', 'What is the term for a mathematical operation that finds the quotient of two numbers, called the dividend and divisor?', 'Division'),
('English Literature', 'What is the title of William Golding''s novel about a group of boys stranded on a deserted island?', 'Lord of the Flies'),
('English Literature', 'Who wrote the novel "To Kill a Mockingbird"?', 'Harper Lee'),
('English Literature', 'What is the title of the novel by Jane Austen that follows the romantic relationships of the Bennet sisters?', 'Pride and Prejudice'),
('English Literature', 'What is the title of the play by William Shakespeare about two star-crossed lovers from feuding families?', 'Romeo and Juliet'),
('English Literature', 'What is the title of the novel by George Orwell that describes a dystopian society where government surveillance and control is omnipresent?', '1984'),
('English Literature', 'What is the title of the novel by Mary Shelley about a scientist who creates a monster?', 'Frankenstein'),
('English Literature', 'Who wrote the play "Hamlet"?', 'William Shakespeare'),
('English Literature', 'What is the title of the novel by F. Scott Fitzgerald that explores the excess and decadence of the 1920s?', 'The Great Gatsby'),
('English Literature', 'What is the title of the novel by J.D. Salinger that follows a disillusioned teenager named Holden Caulfield?', 'The Catcher in the Rye'),
('English Literature', 'Who wrote the play "Macbeth"?', 'William Shakespeare'),
('English Literature', 'What is the title of the novel by Emily Bronte that tells the story of the passionate love between Catherine Earnshaw and Heathcliff?', 'Wuthering Heights'),
('English Literature', 'What is the title of the novel by John Steinbeck that follows the lives of migrant workers in California during the Great Depression?', 'Of Mice and Men'),
('English Literature', 'Who wrote the poem "The Waste Land"?', 'T.S. Eliot'),
('English Literature', 'What is the title of the novel by Arthur Conan Doyle that introduces the detective Sherlock Holmes and his friend Dr. John Watson?', 'A Study in Scarlet'),
('English Literature', 'What is the title of the play by Tennessee Williams that explores themes of illusion and reality through the character of Blanche DuBois?', 'A Streetcar Named Desire'),
('English Literature', 'What is the title of the novel by Charles Dickens that follows the life of an orphan named Pip and his encounters with an escaped convict and a reclusive wealthy woman?', 'Great Expectations'),
('English Literature', 'What is the title of the play by Oscar Wilde that satirizes the manners and morals of Victorian society?', 'The Importance of Being Earnest'),
('English Literature', 'What is the title of the novel by Aldous Huxley that depicts a future society where individuals are conditioned to conform to a rigid social hierarchy?', 'Brave New World'),
('English Literature', 'What is the title of the epic poem by Homer that tells the story of the Trojan War?', 'The Iliad'),
('English Literature', 'What is the title of the novel by Toni Morrison that tells the story of Sethe, a former slave who escaped to Ohio, and her haunted past?', 'Beloved'),
('Sports Science', 'What is the term for the amount of blood pumped by the heart per minute?', 'Cardiac output'),
('Sports Science', 'What is the term for the amount of oxygen that the body can take in and use during exercise?', 'VO2 max'),
('Sports Science', 'What is the term for the range of motion available at a joint?', 'Joint flexibility'),
('Sports Science', 'What is the term for the amount of force that a muscle or group of muscles can generate in a single maximum effort?', 'Muscular strength'),
('Sports Science', 'What is the term for the ability to maintain a certain level of physical activity for a prolonged period of time?', 'Endurance'),
('Sports Science', 'What is the term for the process by which the body converts food into energy?', 'Metabolism'),
('Sports Science', 'What is the term for the ability to change direction quickly and effectively?', 'Agility'),
('Sports Science', 'What is the term for the ability to maintain balance while stationary or moving?', 'Balance'),
('Sports Science', 'What is the term for the ability to move quickly from one point to another?', 'Speed'),
('Sports Science', 'What is the term for the ability to exert a maximal force in as short a time as possible?', 'Power'),
('Sports Science', 'What is the term for the ability to use different parts of the body together smoothly and efficiently?', 'Coordination'),
('Sports Science', 'What is the term for the process of increasing the size of muscle fibers through training?', 'Hypertrophy'),
('Sports Science', 'What is the term for the amount of time it takes for a muscle to contract after receiving a stimulus?', 'Muscle reaction time'),
('Sports Science', 'What is the term for the ability to maintain or control body position while performing an activity?', 'Postural control'),
('Sports Science', 'What is the term for the amount of force a muscle can generate repeatedly over an extended period of time?', 'Muscular endurance'),
('Sports Science', 'What is the term for the ability to jump vertically?', 'Vertical jump'),
('Sports Science', 'What is the term for the process of gradually increasing the intensity or duration of exercise over time?', 'Progressive overload'),
('Sports Science', 'What is the term for the process of restoring the body to its pre-exercise state?', 'Recovery'),
('Sports Science', 'What is the term used to describe the increase in muscle size as a result of resistance training?', 'Hypertrophy'),
('Sports Science', 'What is the name of the energy system used by the body for high-intensity, short-duration activities such as sprinting and weightlifting?', 'ATP-PC system'),
('Religious Education', 'What is the name of the holy book in Islam?', 'Quran'),
('Religious Education', 'Who is considered the founder of Buddhism?', 'Siddhartha Gautama'),
('Religious Education', 'What is the name of the festival celebrated by Jews to commemorate the Exodus from Egypt?', 'Passover'),
('Religious Education', 'What is the name of the Hindu festival of lights?', 'Diwali'),
('Religious Education', 'What is the name of the sacred river in Hinduism?', 'Ganges'),
('Religious Education', 'Who is considered the father of the Jewish people?', 'Abraham'),
('Religious Education', 'What is the name of the pilgrimage to Mecca that Muslims are required to undertake at least once in their lifetime?', 'Hajj'),
('Religious Education', 'What is the name of the belief in Hinduism that every action has a consequence?', 'Karma'),
('Religious Education', 'What is the name of the religious text that is considered the ultimate authority in Sikhism?', 'Guru Granth Sahib'),
('Religious Education', 'What is the name of the Buddhist term that refers to the state of enlightenment?', 'Nirvana'),
('Religious Education', 'Who is considered the founder of Sikhism?', 'Guru Nanak'),
('Religious Education', 'What is the name of the religious text that is considered the ultimate authority in Judaism?', 'Torah'),
('Religious Education', 'What is the name of the Christian festival celebrated on the Sunday before Easter?', 'Palm Sunday'),
('Religious Education', 'What is the name of the Buddhist term that refers to the cycle of birth, death, and rebirth?', 'Samsara'),
('Religious Education', 'What is the name of the Hindu god of destruction and transformation?', 'Shiva'),
('Religious Education', 'Who is considered the founder of Christianity?', 'Jesus Christ'),
('Religious Education', 'What is the name of the religious text that is considered the ultimate authority in Christianity?', 'Bible'),
('Religious Education', 'What is the name of the Jewish holy day that is considered the holiest day of the year?', 'Yom Kippur'),
