...
let populateTestDBEnv = async () => {
  // insert user data
  await db.query("INSERT INTO pg_temp.users (username, email, password, isAdmin) VALUES ('admin', 'admin@test.com', 'admin', TRUE), ('testuser', 'testuser@test.com', 'testuser', FALSE);");
...
module.exports = {createTestDBEnv, destroyTestDBEnv}
